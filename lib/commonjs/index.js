...
const RNAppShortcuts = _reactNative.NativeModules.RNAppShortcuts ? _reactNative.NativeModules.RNAppShortcuts : new Proxy({}, {
  get() {
    throw new Error(LINKING_ERROR);
  }
});
const eventEmitter = new _reactNative.NativeEventEmitter(RNAppShortcuts);
/**
...
var _default = exports.default = AppShortcuts;
